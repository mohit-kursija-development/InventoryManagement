...
class InventoryItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory_item" do
    assert_difference("InventoryItem.count") do
      post inventory_items_url, params: { inventory_item: { description: @inventory_item.description, name: @inventory_item.name, price: @inventory_item.price, quantity: @inventory_item.quantity } }
    end
  ...
  test "should update inventory_item" do
    patch inventory_item_url(@inventory_item), params: { inventory_item: { description: @inventory_item.description, name: @inventory_item.name, price: @inventory_item.price, quantity: @inventory_item.quantity } }
